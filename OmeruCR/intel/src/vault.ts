...
// Lives at OmeruCR/intel/src/ since the Control Room absorbed omeru-intel —
// the shared vault stays at the repo root. Override with OMERU_VAULT_PATH.
export const VAULT_ROOT = process.env.OMERU_VAULT_PATH
  ? resolve(process.env.OMERU_VAULT_PATH)
  : resolve(__dirname, '../../../omeru-vault');
