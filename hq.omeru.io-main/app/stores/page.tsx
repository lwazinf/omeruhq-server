    ...
    <div style={{ background: 'var(--off-white)', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'var(--black)', paddingBottom: 64, position: 'relative', overflow: 'hidden' }}>
        ...
        <nav className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: 'clamp(20px,3vh,28px) clamp(20px,4vw,48px)', position: 'relative', zIndex: 1 }}>
          ...
          <Link href="/" style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', textDecoration: 'none', fontWeight: 500 }}>For merchants →</Link>
        </nav>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, paddingTop: 'clamp(32px,5vh,56px)' }}>
          ...
          <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)', fontWeight: 300 }}>active stores</span>
            </div>
      ...
      <div style={{ paddingTop: 56, paddingBottom: 120 }}>
        {merchants.length === 0 ? (
          <div className="container" style={{ textAlign: 'center', padding: '80px 0' }}>
            <p style={{ fontSize: 17, color: 'var(--mid-gray)', fontWeight: 300 }}>Stores are coming soon — check back shortly.</p>
            <Link href="/" className="btn-lime" style={{ marginTop: 24, display: 'inline-flex' }}>Back to home →</Link>
          </div>
        ) : (
