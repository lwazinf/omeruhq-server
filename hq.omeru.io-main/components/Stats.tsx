...
const stats = [
  { value: 47, suffix: 'M+', label: 'WhatsApp users in South Africa', sub: 'Your customers are already there' },
  { value: 7,  suffix: '%',  label: 'Platform commission',            sub: 'Only charged on successful sales' },
  { value: 24, suffix: 'h',  label: 'From invite to live store',      sub: 'Fastest onboarding in SA commerce' },
  { value: 3,  suffix: '×',  label: 'Higher open rate vs email',      sub: 'WhatsApp messages get read' },
];
      ...
      <div className="container">
        <div style={{
          ...
          <div style={{
            ...
            width: '55%', height: '160%',
            background: 'radial-gradient(ellipse at center, rgba(200,241,53,0.1) 0%, transparent 60%)',
            pointerEvents: 'none',
          }} />
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ marginBottom: 'clamp(32px, 5vw, 52px)' }}>
              ...
              >
                The numbers make<br />
                <span style={{ color: 'var(--lime)' }}>the case.</span>
              </motion.h2>
            </div>
            ...
            <div className="stats-grid">
              {stats.map((s, i) => (
                ...
                >
                  ...
                  <div style={{ fontSize: 14, fontWeight: 500, color: 'rgba(255,255,255,0.65)', marginBottom: 4, lineHeight: 1.4 }}>
                    {s.label}
                  </div>
