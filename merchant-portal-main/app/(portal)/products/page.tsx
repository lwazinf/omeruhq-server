  ...
  return (
    <div style={{ padding: '32px 36px', maxWidth: 1100 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32 }}>
        <div>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 24, fontWeight: 700, letterSpacing: '-0.015em' }}>Products</div>
      ...
      {products.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 0' }}>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 18, fontWeight: 700, marginBottom: 8 }}>No products yet</div>
          <div style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--mid-gray)', marginBottom: 24 }}>Add your first product to start taking orders</div>
          ...
          {products.map(p => (
            <div key={p.id} className="card" style={{ overflow: 'hidden' }}>
              ...
              <div style={{ padding: '16px' }}>
                {p.category && (
                  <div style={{ fontFamily: 'var(--font-body)', fontSize: 10, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--mid-gray)', marginBottom: 6 }}>{p.category}</div>
                )}
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 12 }}>
                  ...
                  <form action={toggleProductAction}>
                    ...
                    <button type="submit" title={p.is_in_stock ? 'Hide from menu' : 'Show on menu'} style={{
