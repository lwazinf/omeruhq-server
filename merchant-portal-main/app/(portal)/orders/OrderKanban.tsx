...
const COLS: { key: string; label: string; next?: string; nextLabel?: string }[] = [
  { key: 'PENDING',          label: 'Pending',    next: undefined,              nextLabel: undefined },
  { key: 'PAID',             label: 'To Prepare', next: 'READY_FOR_PICKUP',    nextLabel: 'Mark Ready' },
  { key: 'READY_FOR_PICKUP', label: 'Ready',      next: 'COMPLETED',            nextLabel: 'Complete' },
  { key: 'COMPLETED',        label: 'Done',       next: undefined,              nextLabel: undefined },
];
          ...
          <div key={col.key}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              <div style={{
                ...
                background: col.key === 'PAID' ? 'var(--lime)' : col.key === 'COMPLETED' ? 'var(--lime-muted)' : 'var(--warm-gray)',
              }} />
